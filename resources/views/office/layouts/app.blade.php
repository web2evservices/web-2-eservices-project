...
<head>
    ...
    <style>
        ...
        .notif-icon.service_request {
            background:#dbeafe;
            color:#2563eb;
        }

        .notif-icon.request_status {
            background:#fef3c7;
            color:#d97706;
        }
        ...
        .notif-icon.appointment_reminder {
            background:#fce7f3;
            color:#db2777;
        }
...
<div class="app-wrapper">
    ...
    <div class="office-topbar">
        ...
        <span style="color:#fff; font-weight:600;">
            @yield('page-title', 'Office Portal')
        </span>
...
(function () {
    ...
    function fetchCount() {
        ...
        .then(r => r.json())
        .then(d => updateBadge(d.unread_count))
        .catch(() => {});
    }
    ...
    function timeAgo(dateStr) {
        ...
        const mins = Math.floor(
            (Date.now() - new Date(dateStr)) / 60000
        );
    ...
    function renderItem(n) {
        ...
        div.className =
            'notif-item' + (n.is_read ? '' : ' unread');

        div.dataset.id = n.id;

        div.innerHTML = `
            <div class="notif-icon ${meta.css}">
    ...
    function loadNotifications() {
        ...
        .catch(() => {
            ...
            list.innerHTML =
                '<div class="notif-empty text-danger">Could not load notifications.</div>';
        });
    }
